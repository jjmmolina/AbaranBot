...
# updater.dispatcher.add_handler(CommandHandler('weather', self.getWeather, pass_args=True))
# updater.dispatcher.add_handler(CommandHandler('forecast', self.getForecast, pass_args=True))
